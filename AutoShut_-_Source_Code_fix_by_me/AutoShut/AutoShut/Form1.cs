...
namespace AutoShut
{
    public partial class frmAutoShut : Form
    {
        ...
        {
            //Shutdown when this timer ticks, and disable it
            MessageBox.Show("AutoShut time has finished\nShutting your computer NOW!");
        ...
        private void btnStart_Click(object sender, EventArgs e)
        {
            ...
            //label2.Text = "timer1: " + timer1.Interval.ToString() + " timer2: " + timer2.Interval.ToString();
            flag: ;
        }
        ...
        public string GetTime()
        {
            update_timespan();
            string TimeInString = "";
            int hour = AutoShutTimeSpan.Hours + (24 * AutoShutTimeSpan.Days);//DateTime.Now.Hour;
            int min = AutoShutTimeSpan.Minutes;//DateTime.Now.Minute;
            int sec = AutoShutTimeSpan.Seconds;//DateTime.Now.Second;
            int miliSec = AutoShutTimeSpan.Milliseconds; //DateTime.Now.Millisecond;
